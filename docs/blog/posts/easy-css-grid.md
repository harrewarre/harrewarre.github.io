...
![Simple columns](assets/easy-css-grid/simple-columns.png)
...
![Fixed width columns](assets/easy-css-grid/fixed-width-columns.png)

With this example in hand, we can now create all sorts of layouts any way we like.

![Mixing it up](assets/easy-css-grid/mixed-columns.png)
