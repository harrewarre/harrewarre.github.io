...
Setting up a webserver with Node and [Express](http://expressjs.com/) is easy very easy.
<!-- more -->
...
![Hello world](assets/expressjs-route-management/hw.png)
...
![Filestructure](assets/expressjs-route-management/fs.png)
...
![Hello!](assets/expressjs-route-management/fs-1.png)

![Hello world!](assets/expressjs-route-management/fs-2.png)
...
![Bye](assets/expressjs-route-management/fs-3.png)
