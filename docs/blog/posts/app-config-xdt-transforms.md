...
![Configs!](assets/app-config-xdt-transforms/web-1.png)
...
![New Config](assets/app-config-xdt-transforms/web1.png)
...
![Debug](assets/app-config-xdt-transforms/debug.png)
And `Release` produces this:
![Release](assets/app-config-xdt-transforms/release.png)
