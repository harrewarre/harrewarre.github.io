...
![CF Marketplace](assets/rabbitmq-with-nodejs-on-cloud-foundry/cf-market.png)
...
![Environment variables](assets/rabbitmq-with-nodejs-on-cloud-foundry/env-var.png)
